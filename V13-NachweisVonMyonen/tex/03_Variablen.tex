...
\newcommand*{\varNum}{V13}
% Name laut Praktikumsheft:
\newcommand*{\varName}{The detection of $\mu$ \\ in cosmic radiation}
% Datum der Durchführung:
\newcommand*{\varDatumA}{11.11.2019}
\newcommand*{\varDatumB}{20.11.2019}
...
\newcommand*{\varGruppe}{Group Ma-A-06}
...
%betreuer Name
\newcommand{\varBetreuer}{Alexey Lohkov}
