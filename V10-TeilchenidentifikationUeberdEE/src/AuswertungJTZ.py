...
plt.grid(True)
plt.savefig("EDetectorCalibrationChannelSpectrumEDetector.pdf")
plt.show()
print(output.beta)
...
plt.tick_params(labelsize=16)
plt.grid(True)
plt.savefig("EDetectorCalibration.pdf")
plt.show()
print(output1.beta)
...
plt.plot(channel, Gaussian(output2.beta, channel), "-r", linewidth=3.5, zorder=3, label="Gaußsche"+"\n"+"Anpassungskurve"+"\n"+r"mit $\mu=130,4\pm 0,2$"+"\n"+r"und $\sigma=2,93\pm 0,16$")
plt.legend(loc="best", fontsize=18)
plt.xlabel(r"Kanal $K$", fontsize=20)
plt.ylabel(r"Counts $N$", fontsize=20)
plt.xlim(-5., 205.)
...
plt.tick_params(labelsize=16)
plt.grid(True)
plt.savefig("dEDetectorCalibrationChannelSpectrumEDetector.pdf")
plt.show()
print(output2.beta)
...
plt.plot(channel, Gaussian(output3.beta, channel), "-r", linewidth=3.5, zorder=3, label="Gaußsche"+"\n"+"Anpassungskurve"+"\n"+r"mit $\mu=84,30\pm 0,08$"+"\n"+r"und $\sigma=4,84\pm 0,19$")
plt.legend(loc="best", fontsize=18)
plt.xlabel(r"Kanal $K$", fontsize=20)
plt.ylabel(r"Counts $N$", fontsize=20)
plt.xlim(-5., 205.)
...
plt.tick_params(labelsize=16)
plt.grid(True)
plt.savefig("dEDetectorCalibrationChannelSpectrumdEDetector.pdf")
plt.show()
print(output3.beta)
...
plt.tick_params(labelsize=16)
plt.grid(True)
plt.savefig("dEDetectorCalibration.pdf")
plt.show()
print(output4.beta)
...
plt.annotate(r"$E_{0} - \Delta E$", xy=(E_0 - EnergyLoss + 50., 111.), fontsize=18, color="C1", zorder=4)
plt.annotate(r"$E_{0}$", xy=(E_0 + 50., 111.), fontsize=18, color="C1", zorder=4)
plt.plot(IonEnergy, dEdx, marker="o", markersize=9., color="C0", zorder=3, label="Tabellenwerte")
plt.plot(np.linspace(1000., 7000., 6000), dEdx_interpolated(np.linspace(1000., 7000., 6000)), "-g", linewidth=3.5, zorder=2, label="Kubische Spline-Interpolation")
plt.legend(loc="best", fontsize=18)
...
plt.tick_params(labelsize=16)
plt.grid(True)
plt.savefig("EnergyLossSpectrum.pdf")
plt.show()
