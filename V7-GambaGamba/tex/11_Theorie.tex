...
\end{split}
\end{align}
Das heißt, über die Kugelflächenfunktionen $Y^m_l(\theta,\Phi)$ lässt sich die Winkelverteilung berechnen. Für die hier untersuchten $\gamma$-Kaskade beim Zerfall von $^{60}_{27}$Co in $^{60}_{28}$Ni erwartet man:
\begin{align}
